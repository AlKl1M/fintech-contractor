...
class ContractorControllerTest {
    ...
    void testGetContractorsByParameters() throws Exception {
    ...
    @Test
    @Sql("/sql/contractors.sql")
    void testGetContractorsByParameters_1() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.post("/contractor/search")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("""
                {"id":"1",
    ...
    @Test
    void testSaveOrUpdateContractor() throws Exception {
    ...
    @Test
    void testSaveOrUpdateContractor_exception() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.put("/contractor/save")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("""
                {
                ...
                .andExpectAll(
                        status().isBadRequest(),
                        content().json("""
                        {"message":"Validation failed.","errors":{"orgForm_id":"Organization Form ID cannot be null","industry_id":"Industry ID cannot be null","name":"Name cannot be null","id":"Id cannot be null","country_id":"Country ID cannot be null"}}
                        """)
                );
    }
    ...
    @Test
    @Sql("/sql/contractors.sql")
    void testGetContractorPageableById() throws Exception {
    ...
    @Test
    @Sql("/sql/contractors.sql")
    void testFindContractorWithDetailsById() throws Exception {
